...
export const metadata: Metadata = {
  title: 'Outdoor Transformation | Free Design Consultation',
  description:
    'Transform your outdoor space with custom landscape design, expert hardscaping, and professional installation. Serving Austin Metro for 16+ years. Get a free consultation.',
};
...
const benefits = [
  ...
  },
  {
    ...
    description:
      'Licensed General Contractor of Landscape. Fully bonded and insured with a 1-year service guarantee on all work.',
  },
  {
    icon: Zap,
...
const commonProjects = [
  'Complete backyard renovation and redesign',
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'We are a true full-service firm — design, hardscaping, carpentry, metal fabrication, softscaping, lighting, irrigation, and ongoing maintenance all under one roof. You get a single point of contact and a licensed General Contractor of Landscape overseeing every detail. That level of integration and accountability is rare in this industry.',
  },
  {
...
export default function OutdoorTransformationLP() {
  return (
    <>
      {/* ==================== HERO ==================== */}
      <section className="relative bg-dark text-white overflow-hidden">
        <Image
          ...
          alt="Aerial view of a beautifully designed outdoor estate"
          fill
          priority
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="max-w-xl">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-4">
                ...
                <span className="text-primary-light">Get a Free Design Consultation</span>
              </h1>
              <p className="font-body text-lg text-gray-300 mb-8 leading-relaxed">
                From custom landscape design to expert installation, our licensed team brings your
                outdoor vision to life. Serving Austin&apos;s most discerning homeowners for 16+
                years.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-[4/3]">
              <Image
                ...
                alt="Professional landscape project by Outdoor Renovations"
                fill
                className="object-cover"
      ...
      {/* ==================== FAQ ==================== */}
      <FAQAccordion faqs={faqs} title="Outdoor Transformation FAQs" />
      ...
      <section className="relative bg-dark text-white overflow-hidden">
        ...
        <div className="relative container-narrow section-padding text-center">
          ...
          <p className="font-body text-gray-300 text-lg max-w-2xl mx-auto mb-6">
            Schedule your free design consultation today. No obligation, no pressure — just a
            conversation about what is possible for your property.
          </p>
